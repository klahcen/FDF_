...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/20 14:09:16 by lkazaz            #+#    #+#             */
/*   Updated: 2024/01/20 15:06:05 by lkazaz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_initm0(t_pix *param)
{
	...
	param->win_ptr = mlx_new_window(param->mlx_ptr, param->win_x, param->win_y,
			"FDF");
	mlx_string_put(param->mlx_ptr, param->win_ptr, param->shift_x - 130,
		param->shift_y, 0x0000FF, "😈 WELCOME TO MY BONUS PART '😀' PDF");
	mlx_string_put(param->mlx_ptr, param->win_ptr, param->shift_x - 100,
		param->shift_y + 40, 0x0000FF, "I HAPPY FOR YOU JOINED...👈");
}
